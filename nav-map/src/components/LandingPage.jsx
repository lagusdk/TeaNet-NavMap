...
const LandingPage = () => {
  ...
  return (
    <div className="landing-page">
      ...
      <div className="hero-section fade-in" ref={(el) => fadeInElementsRef.current.push(el)}>
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="hero-subtitle" ref={heroSubtitleRef}>
            전공 커리큘럼부터 진로 계획까지, 당신만의 특별한 여정을 AI와 함께 설계하세요
          </p>
        ...
        <div className="card fade-in" ref={(el) => fadeInElementsRef.current.push(el)}>
          <div className="card-content">
            ...
            <ul className="card-description">
              <li className="feature-item fade-in" ref={(el) => fadeInElementsRef.current.push(el)}>
      ...
      {/* How It Works */}
      <div className="text-center how-it-works fade-in" ref={(el) => fadeInElementsRef.current.push(el)}>
        <h3 className="section-title text-center">AI 기반 맞춤형 가이드</h3>
        <div className="steps-container vertical">
          <div className="step-card fade-in" ref={(el) => { stepCardsRef.current[0] = el; fadeInElementsRef.current.push(el); }}>
            <div className="icon-container">
              <span className="step-number">01</span>
            </div>
            <h4 className="step-title">키워드 선택</h4>
            <p className="step-description">관심 분야와 목표를 선택하여 <br /> 맞춤형 분석을 시작합니다</p>
          </div>
          
          <div className="step-card fade-in" ref={(el) => { stepCardsRef.current[1] = el; fadeInElementsRef.current.push(el); }}>
            <div className="icon-container">
              <span className="step-number">02</span>
            </div>
            <h4 className="step-title">AI 분석</h4>
            <p className="step-description">AI가 최적의 학습 경로와 <br /> 진로 방향을 분석합니다</p>
          </div>
          
          <div className="step-card fade-in" ref={(el) => { stepCardsRef.current[2] = el; fadeInElementsRef.current.push(el); }}>
            <div className="icon-container">
              <span className="step-number">03</span>
            </div>
            <h4 className="step-title">맞춤형 플랜</h4>
            <p className="step-description">상세한 학습 계획과 <br /> 진로 로드맵을 제공받습니다</p>
          </div>
        </div>
      </div>
      ...
      {/* Footer */}
      <footer className="footer fade-in" ref={(el) => fadeInElementsRef.current.push(el)}>
